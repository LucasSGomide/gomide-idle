...
| [02](02-api-app-boots-with-validated-environment.md) | The API app boots on Fastify with a validated environment | back-end | 01 | 0/10 | not-started |
| [03](03-error-shape-log-shape-and-observability.md) | The normalised error shape, the log shape and observability | back-end | 02 | 0/9 | not-started |
| [04](04-postgres-drizzle-and-the-server-meta-migration.md) | Postgres, Drizzle and the `server_meta` migration | back-end | 02 | 0/9 | not-started |
| [05](05-the-server-meta-read-path.md) | The `server_meta` read path, port to controller | back-end | 03, 04 | 0/9 | not-started |
| [06](06-socket-handshake-and-its-error-twin.md) | The socket handshake and its error twin | back-end | 03 | 0/8 | not-started |
