...
|---|---|---|---|---|---|
| [01](01-web-scaffold-six-folders-and-boundary-checker.md) | The web app scaffold, its six folders and the boundary checker | front-end | — | 8/8 | done |
| [02](02-token-generator-theme-and-tailwind.md) | The token generator, the theme, the fonts and Tailwind v4 | front-end | 01 | 8/8 | done |
| [03](03-i18n-catalogues-typed-resources-and-mirror.md) | Both catalogues, the typed resources and the `localStorage` mirror | front-end | 01 | 7/7 | done |
| [04](04-router-shell-and-top-bar.md) | The router, the root shell and the top bar | front-end | 02, 03 | 8/8 | done |
| [05](05-generated-client-mutator-and-msw.md) | The generated client, the fetch mutator and the network fake | front-end | 01 | 5/5 | done |
| [06](06-error-boundary-catalogue-and-footer.md) | The error boundary, the error catalogue and the footer | front-end | 04, 05 | 8/8 | done |
| [07](07-socket-client-and-out-of-date-screen.md) | The socket client and the out-of-date screen | front-end | 04 | 6/6 | done |
