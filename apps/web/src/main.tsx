...
import { createUnauthorizedHandler } from './features/session/handle-unauthorized';
...
// cache are in scope. The screens never touch it; its body lives in
// features/session/ beside its two twins, where it is testable.
