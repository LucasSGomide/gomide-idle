...
// is docs/design-tokens.json (design.md declares it the source of truth); the
// outputs are apps/web/src/theme.css and apps/web/src/theme.ts, both drift-
// checked in CI (FR.16.1).
